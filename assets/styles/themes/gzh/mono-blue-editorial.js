/**
 * 墨蓝刊读风 — black-and-white magazine editorial with Klein blue as the sole
 * accent (black masthead cover, serif numbered chapters, square-cut frames).
 * Upstream preview: assets/theme-previews/theme-mono-blue-editorial.html
 * (unregistered 7th candidate theme of isjiamu/gzh-design-skill).
 */
...
function chapter(h2, { index, number, tag, scale }) {
  ...
  // A heading cannot live inside a paragraph. Using a block container keeps
  // the number and H2 on the same baseline instead of the browser splitting
  // the row around the heading.
