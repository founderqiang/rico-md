/**
 * 橄榄手记 — internal-journal components (hero masthead card, PART headers
 * with vertical rule, inset-orange highlight titles, editors-note intro).
 * Upstream: theme-olive-journal.md.
 */
